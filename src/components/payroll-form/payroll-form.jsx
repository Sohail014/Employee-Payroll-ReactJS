...
class PayrollForm extends React.Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault();
        //debugger;
        const formDate = (this.state.Day+ "," +this.state.Month + ","+this.state.Year);
    ...
    render () {
        ...
        return (
            ...
            <div class="row-content"> <label class="label-text" for="StartDate"></label> <input type="date" class="startDate" id="StartDate" name="date"  required/> </div>
        </div>
                        {/* <div className="row-content" >
